...
.chart-container{{height:200px;margin-top:10px;background:#1e222d;border-radius:8px;overflow:hidden;contain:layout style;transform:translateZ(0);will-change:transform}}
